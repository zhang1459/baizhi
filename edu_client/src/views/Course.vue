    ...
    <div class="main">
      ...
      <div class="condition">
        ...
        <div class="ordering">
          ...
          <p class="condition-result">共{{ course_num }}个课程</p>
        </div>
      ...
      <div class="course-list">
        ...
        <div class="course-item" v-for="(course, index) in course_list" :key="index" @click="get_course_id(course.id)">
          ...
          <div class="course-info">
            ...
            <div class="pay-box" v-else>
              ...
              <span style="font-size: 25px">价格：{{ course.price }}元</span>
              <span class="buy-now">立即购买</span>
            </div>
  ...
  methods: {
    ...
    get_all_course() {
      ...
      this.$axios.get(this.$settings.HOST + "course/courses/", {
        ...
        this.course_num = res.data.count
